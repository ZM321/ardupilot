...
public:
    ...
    void set_beacon_distance(uint8_t beacon_instance, float distance, bool beacon_healthy = true);
    ...
    AP_Beacon::AP_BeaconType type() const { return (AP_Beacon::AP_BeaconType)_frontend._type.get(); }
