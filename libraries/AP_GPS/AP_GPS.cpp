...
const AP_Param::GroupInfo AP_GPS::var_info[] = {
    ...
    // @Values: 0:None,1:AUTO,2:uBlox,3:MTK,4:MTK19,5:NMEA,6:SiRF,7:HIL,8:SwiftNav,9:UAVCAN,10:SBF,11:GSOF,13:ERB,14:MAV,15:NOVA,16:YCHIOT
    // @RebootRequired: True
    // @User: Advanced
...
void AP_GPS::detect_instance(uint8_t instance)
{
    ...
    case GPS_TYPE_YCHIOT:
        dstate->auto_detected_baud = false; // specified, not detected
        new_gps = new AP_GPS_YCHIOT(*this, state[instance], nullptr);
        goto found_gps;
        break;
